...
# 物件検索URL
BASE_URL = "https://suumo.jp/jj/chintai/ichiran/FR301FC001/?ar=030&bs=040&ta=13&sc=13101&cb=0.0&ct=9999999&et=9999999&md=05&md=06&md=07&md=08&md=09&md=10&md=11&md=12&md=13&md=14&ts=1&cn=9999999&mb=0&mt=9999999&shkr1=03&shkr2=03&shkr3=03&shkr4=03&fw2="
...
# ジオコーダーの初期化
from geopy.geocoders import Nominatim
geolocator = Nominatim(user_agent="your_app_name")  # "your_app_name"は任意の名前に置き換えてください
...
def process_real_estate_data(dataframe):
    ...
    """
    # 住所から緯度と経度を取得し、新しい列に追加
    dataframe['latitude'], dataframe['longitude'] = zip(*dataframe['アドレス'].apply(get_lat_lon))
